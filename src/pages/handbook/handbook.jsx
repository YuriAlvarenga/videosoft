...
export default function Handbook() {
    ...
    const [categories, setCategories] = useState([
        {
            children: [
                { id: 101, name: 'JORNADA' },
                { id: 102, name: 'INSTALAÇÃO' },
                { id: 103, name: 'ACESSAR ADMINISTRATIVO' },
                { id: 104, name: 'GERAR TOKEN' },
                { id: 105, name: 'ESTORNOS' },
            ],
        },
    ])
    ...
    return (
        <React.Fragment>
            <AppBar sx={{display:'flex', alignItems:'center', background:'#000000'}}><Typography>Manual</Typography></AppBar>
